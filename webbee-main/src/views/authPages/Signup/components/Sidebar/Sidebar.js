      ...
      <Box>
        <Slider {...sliderOpts}>
          {[
            {
              feedback:
                'Working with Scrapper is fantastic! Simple, and fast workflow, all in one platform.',
            ...
            {
              feedback:
                'This is great bundle. Absolutelly love it! 10 out of 10.',
              image: 'https://assets.maccarianagency.com/avatars/img2.jpg',
              name: 'Jhon Anderson',
              title: 'Senior Frontend Developer',
            },
            {
              feedback: 'Love the app..',
